...
class FloatAdapter : CommandAdapter<Float> {

    override fun transform(sender: CommandSender, value: String): Float = value.toFloat()
    ...
    override fun getTransformType(): Class<*> = Float::class.java
}